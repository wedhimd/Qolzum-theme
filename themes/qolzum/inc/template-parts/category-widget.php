...
<div class="widget">
    ...
    <div class="widget-content">
        <div class="categories">
            <ul>
                <li><a href="category/news/"> الأخبار</a><span><?php echo count_cat_post("news"); ?></span></li>
                <li><a href="category/politics/"> سياسة</a><span><?php echo count_cat_post("politics"); ?></span></li>
                <li><a href="category/politics/local/"> القرن الإفريقي</a><span><?php echo count_cat_post("local"); ?></span></li>
                <li><a href="category/politics/world/"> العالم</a><span><?php echo count_cat_post("world"); ?></span></li>
